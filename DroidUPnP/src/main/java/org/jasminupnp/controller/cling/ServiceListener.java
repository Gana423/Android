...
import org.jasminupnp.model.cling.CRegistryListener;
import org.jasminupnp.model.mediaserver.MediaServer;
import org.jasminupnp.model.upnp.ICallableFilter;
...
public class ServiceListener implements IServiceListener
{
	...
	private static final String TAG_1 = "**********Code Debuggr:";
	...
	{
		Log.i(TAG_1, "Control is in ServiceListener()");
	...
	public void refresh()
	{
		Log.i(TAG_1, "Control is in refresh()");
	...
	{
		Log.i(TAG_1, "Control is in getDeviceList()");
